...
* [Eight general types ]
    * [Health for services, roles](https://www.cloudera.com/documentation/enterprise/5-12-x/topics/cm_dg_service_monitoring.html)
    * [Resource management](https://www.cloudera.com/documentation/enterprise/5-12-x/topics/cm_dg_resource_management_monitoring.html)
...
## <center> <a name="cm_alerts">[Adding Alerts]</a>
...
* Two types
    * Pass-fail
    * ["Metric"](https://www.cloudera.com/documentation/enterprise/5-12-x/topics/cm_metrics.html) - set to some numeric threshold
    * [Complete health tests list for CM5](https://www.cloudera.com/documentation/enterprise/5-12-x/topics/cm_ht.html)
...
* Chart builder and dashboard editor: CM -> Charts
    * [Documentation](https://www.cloudera.com/documentation/enterprise/5-12-x/topics/cm_dg_chart_time_series_data.html)
    * A user's collection of charts is a [dashboard](https://www.cloudera.com/documentation/enterprise/5-12-x/topics/cm_dg_dashboards.html) in 5.x
* [Metric aggregations](https://www.cloudera.com/documentation/enterprise/5-12-x/topics/cm_dg_metric_aggregation.html)
...
* [CDH properties by version](https://www.cloudera.com/documentation/enterprise/5-12-x/topics/cm_props_top.html)
...
* Tutorials available for each version
  * [Version 16](http://cloudera.github.io/cm_api/)
* Plenty of examples
...
* Create a new CM user `tarkin` in your cluster
* Assign the Configurator role  to `tarkin`
* Create a dashboard for `tarkin` and add any four charts  
...
* Follow the [tutorial for API v12](http://cloudera.github.io/cm_api/apidocs/v18/tutorial.html)
